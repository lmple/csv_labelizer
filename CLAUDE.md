...
- Rust 1.94 (backend) + TypeScript 5.6 (frontend) + Tauri v2.0, csv crate 1.3, serde 1.0, Vite 6.0 (007-exact-word-search)
...
## Recent Changes
- 007-exact-word-search: Added Rust 1.94 (backend) + TypeScript 5.6 (frontend) + Tauri v2.0, csv crate 1.3, serde 1.0, Vite 6.0
